...
<%@ Register Src="~/AddressUserControl.ascx" TagPrefix="uc1" TagName="AddressUserControl" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td class="auto-style2"> <asp:Label ID="lblDateOfBirth" Text="DateOfBirth" runat="server" ></asp:Label></td>
            ...
            <tr>
                ...
                <td class="auto-style2"> <asp:Label ID="lblPassword" runat="server" Text="Password"></asp:Label> </td>
            ...
            <tr>
                <td class="auto-style2"> <asp:Label ID="lblConfirmPassword" runat="server" Text="ConfirmPassword" ></asp:Label></td>
